...
class AppTheme {
  static const Color _primaryColor = Color(
    0xFFE3E0E7,
  ); // Color(0xFF0626A9); //Color.fromARGB(255, 6, 38, 169); //Color(0xFF364B9C); 0x0626A9
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    // Asegura contraste correcto para botones de diálogos y textos
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(
        foregroundColor: _secondaryColor,
        textStyle: const TextStyle(fontFamily: 'Calibri', fontFamilyFallback: ['Roboto']),
      ),
    ),
    // Note: Avoid dialogTheme mismatch across Flutter versions; rely on textButtonTheme and colorScheme instead.

...
class News {
  const News({required this.content});

  factory News.fromJson(Map<String, dynamic> json) {
    return News(content: (json['content']) as String);
  }
...
void transactionUpdate(Transaction transaction, {String? title,
FieldValue titleFieldValue,
String? subtitle,
FieldValue subtitleFieldValue,
String? content,
...
///
/// The update will fail if applied to a document that does not exist.
void batchUpdate(WriteBatch batch, {String? title,
FieldValue titleFieldValue,
String? subtitle,
FieldValue subtitleFieldValue,
String? content,
...
FieldValue? bannerImageUrlFieldValue,
  ...
  Future<void> update({Object? title = _sentinel,
FieldValue? titleFieldValue,
...
void transactionUpdate(Transaction transaction, {Object? title = _sentinel,
FieldValue? titleFieldValue,
Object? subtitle = _sentinel,
FieldValue? subtitleFieldValue,
Object? content = _sentinel,
...
void batchUpdate(WriteBatch batch, {Object? title = _sentinel,
FieldValue? titleFieldValue,
Object? subtitle = _sentinel,
FieldValue? subtitleFieldValue,
Object? content = _sentinel,
...
abstract class NewsCollectionReference
      implements
        NewsQuery,
        FirestoreCollectionReference<News, NewsQuerySnapshot> {
  factory NewsCollectionReference([
  FirebaseFirestore? firestore,
]) = _$NewsCollectionReference;

  static News fromFirestore(
    DocumentSnapshot<Map<String, Object?>> snapshot,
    SnapshotOptions? options,
  ) {
    return News.fromJson({'id': snapshot.id, ...?snapshot.data()});
  }
  ...
  @override
  CollectionReference<News> get reference;



  @override
  NewsDocumentReference doc([String? id]);

  /// Add a new document to this collection with the specified data,
  /// assigning it a document ID automatically.
  Future<NewsDocumentReference> add(News value);
}
...
class _$NewsCollectionReference
  ...
  _$NewsCollectionReference._(
    CollectionReference<News> reference,
  ) : super(reference, $referenceWithoutCursor: reference);
  ...
  @override
  CollectionReference<News> get reference => super.reference as CollectionReference<News>;
  ...
  Future<NewsDocumentReference> add(News value) {
    return reference
      .add(value)
      .then((ref) => NewsDocumentReference(ref));
  }
...
abstract class NewsDocumentReference extends FirestoreDocumentReference<News, NewsDocumentSnapshot> {
  factory NewsDocumentReference(DocumentReference<News> reference) = _$NewsDocumentReference;

  DocumentReference<News> get reference;
  ...
  @override
  Stream<NewsDocumentSnapshot> snapshots();

  @override
  Future<NewsDocumentSnapshot> get([GetOptions? options]);
...
class _$NewsDocumentReference
      extends FirestoreDocumentReference<News, NewsDocumentSnapshot>
      implements NewsDocumentReference {
  _$NewsDocumentReference(this.reference);

  @override
  final DocumentReference<News> reference;
  ...
  @override
  Stream<NewsDocumentSnapshot> snapshots() {
    return reference.snapshots().map(NewsDocumentSnapshot._);
  }

  @override
  Future<NewsDocumentSnapshot> get([GetOptions? options]) {
    return reference.get(options).then(NewsDocumentSnapshot._);
  }

  @override
  Future<NewsDocumentSnapshot> transactionGet(Transaction transaction) {
    return transaction.get(reference).then(NewsDocumentSnapshot._);
  }
...
void batchSet(
  ...
  Future<void> update({Object? content = _sentinel,
FieldValue? contentFieldValue,}) async {
          assert(
          content == _sentinel || contentFieldValue == null,
          "Cannot specify both content and contentFieldValue",
        );
...
FieldValue? contentFieldValue,}) {
  ...
  batch.update(reference, json);
    ...
    @override
  bool operator ==(Object other) {
    return other is NewsDocumentReference
      && other.runtimeType == runtimeType && other.parent == parent && other.id == id;
  }
...
abstract class NewsQuery implements QueryReference<News, NewsQuerySnapshot> {
  @override
  NewsQuery limit(int limit);

  @override
  NewsQuery limitToLast(int limit);

  
NewsQuery whereDocumentId( {String? isEqualTo,String? isNotEqualTo,String? isLessThan,String? isLessThanOrEqualTo,String? isGreaterThan,String? isGreaterThanOrEqualTo,List<String>? whereIn,List<String>? whereNotIn,bool? isNull,});

NewsQuery whereContent( {String? isEqualTo,String? isNotEqualTo,String? isLessThan,String? isLessThanOrEqualTo,String? isGreaterThan,String? isGreaterThanOrEqualTo,List<String>? whereIn,List<String>? whereNotIn,bool? isNull,});

    
  NewsQuery orderByDocumentId( {
    bool descending = false,
    String? startAt,
    String? startAfter,
    String? endAt,
    String? endBefore,
    NewsDocumentSnapshot? startAtDocument,
    NewsDocumentSnapshot? endAtDocument,
    NewsDocumentSnapshot? endBeforeDocument,
    NewsDocumentSnapshot? startAfterDocument,
  });

  
  NewsQuery orderByContent( {
    bool descending = false,
    String? startAt,
    String? startAfter,
    String? endAt,
...
class _$NewsQuery
    extends QueryReference<News, NewsQuerySnapshot>
    implements NewsQuery {
  _$NewsQuery(
    this._collection, {
    required Query<News> $referenceWithoutCursor,
    $QueryCursor $queryCursor = const $QueryCursor(),
  })  : super(
          $referenceWithoutCursor: $referenceWithoutCursor,
          $queryCursor: $queryCursor,
  ...
  @override
  Stream<NewsQuerySnapshot> snapshots([SnapshotOptions? options]) {
    return reference.snapshots().map(NewsQuerySnapshot._fromQuerySnapshot);
  }
  

  @override
  Future<NewsQuerySnapshot> get([GetOptions? options]) {
    return reference.get(options).then(NewsQuerySnapshot._fromQuerySnapshot);
  }
  ...
  NewsQuery limitToLast(int limit) {
    ...
    @override
  NewsQuery whereDocumentId( {Object? isEqualTo = _sentinel,Object? isNotEqualTo = _sentinel,Object? isLessThan,Object? isLessThanOrEqualTo,Object? isGreaterThan,Object? isGreaterThanOrEqualTo,List<String>? whereIn,List<String>? whereNotIn,bool? isNull,}) {
    return _$NewsQuery(
      _collection,
      $referenceWithoutCursor: $referenceWithoutCursor.where(FieldPath.documentId, isEqualTo: isEqualTo != _sentinel ? isEqualTo : null,isNotEqualTo: isNotEqualTo != _sentinel ? isNotEqualTo : null,isLessThan: isLessThan,isLessThanOrEqualTo: isLessThanOrEqualTo,isGreaterThan: isGreaterThan,isGreaterThanOrEqualTo: isGreaterThanOrEqualTo,whereIn: whereIn,whereNotIn: whereNotIn,isNull: isNull ?? (isEqualTo == null ? false : null) ?? (isNotEqualTo == null ? true : null),),
      $queryCursor: $queryCursor,
  ...
  @override
  NewsQuery whereContent( {Object? isEqualTo = _sentinel,Object? isNotEqualTo = _sentinel,Object? isLessThan,Object? isLessThanOrEqualTo,Object? isGreaterThan,Object? isGreaterThanOrEqualTo,List<String>? whereIn,List<String>? whereNotIn,bool? isNull,}) {
    return _$NewsQuery(
      _collection,
      $referenceWithoutCursor: $referenceWithoutCursor.where('content', isEqualTo: isEqualTo != _sentinel ? (isEqualTo as String) : null,isNotEqualTo: isNotEqualTo != _sentinel ? (isNotEqualTo as String) : null,isLessThan: isLessThan != null ? (isLessThan as String) : null,isLessThanOrEqualTo: isLessThanOrEqualTo != null ? (isLessThanOrEqualTo as String) : null,isGreaterThan: isGreaterThan != null ? (isGreaterThan as String) : null,isGreaterThanOrEqualTo: isGreaterThanOrEqualTo != null ? (isGreaterThanOrEqualTo as String) : null,whereIn: whereIn?.map((e) => (e)),whereNotIn: whereNotIn?.map((e) => (e)),isNull: isNull ?? (isEqualTo == null ? false : null) ?? (isNotEqualTo == null ? true : null),),
      $queryCursor: $queryCursor,
...
class NewsDocumentSnapshot extends FirestoreDocumentSnapshot<News> {
  NewsDocumentSnapshot._(this.snapshot): data = snapshot.data();

  @override
  final DocumentSnapshot<News> snapshot;

  @override
  NewsDocumentReference get reference {
    return NewsDocumentReference(
      snapshot.reference,
    );
  }
...
class NewsQuerySnapshot extends FirestoreQuerySnapshot<News, NewsQueryDocumentSnapshot> {
  NewsQuerySnapshot._(
    this.snapshot,
    this.docs,
    this.docChanges,
  ...
  factory NewsQuerySnapshot._fromQuerySnapshot(
    QuerySnapshot<News> snapshot,
  ) {
    final docs = snapshot
      .docs
      .map(NewsQueryDocumentSnapshot._)
      .toList();

    final docChanges = snapshot.docChanges.map((change) {
      return _decodeDocumentChange(
        change,
        NewsDocumentSnapshot._,
      );
    }).toList();

    return NewsQuerySnapshot._(
      snapshot,
      docs,
      docChanges,
    );
  ...
  static FirestoreDocumentChange<NewsDocumentSnapshot> _decodeDocumentChange<T>(
    DocumentChange<T> docChange,
    NewsDocumentSnapshot Function(DocumentSnapshot<T> doc) decodeDoc,
  ) {
    return FirestoreDocumentChange<NewsDocumentSnapshot>(
      type: docChange.type,
      oldIndex: docChange.oldIndex,
      newIndex: docChange.newIndex,
      doc: decodeDoc(docChange.doc),
  ...
  final QuerySnapshot<News> snapshot;

  @override
  final List<NewsQueryDocumentSnapshot> docs;

  @override
  final List<FirestoreDocumentChange<NewsDocumentSnapshot>> docChanges;
}

class NewsQueryDocumentSnapshot extends FirestoreQueryDocumentSnapshot<News> implements NewsDocumentSnapshot {
  NewsQueryDocumentSnapshot._(this.snapshot): data = snapshot.data();

  @override
  final QueryDocumentSnapshot<News> snapshot;
  ...
  @override
  NewsDocumentReference get reference {
    return NewsDocumentReference(snapshot.reference);
  }
}

...
import 'package:javier_website/view/portfolio/portfolio_import_page.dart';
...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: RoutPaths.portfolioImport,
        name: RoutNames.portfolioImport,
        builder: (context, state) => const PortfolioImportPage(),
      ),
